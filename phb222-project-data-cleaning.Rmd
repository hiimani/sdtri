...
tracts <- tracts %>% left_join(intersections %>% st_drop_geometry(), by = "TRACTCE") %>% select(-total_area.y)
...
write.csv(final <- dat %>% st_drop_geometry(), "merged_data.csv") # NO geographies
